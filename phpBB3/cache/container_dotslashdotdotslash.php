...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'cache.driver.install' => 'getCache_Driver_InstallService',
            ...
            'event.listener_collection' => 'getEvent_ListenerCollectionService',
            'event.subscriber_loader' => 'getEvent_SubscriberLoaderService',
            'ext.finder' => 'getExt_FinderService',
    ...
    {
        return $this->services['auth.provider.db'] = new \phpbb\auth\provider\db($this->get('dbal.conn'), $this->get('config'), $this->get('passwords.manager'), $this->get('request'), $this->get('user'), './../', 'php');
    }
    ...
    {
        return $this->services['auth.provider.oauth'] = new \phpbb\auth\provider\oauth\oauth($this->get('dbal.conn'), $this->get('config'), $this->get('passwords.manager'), $this->get('request'), $this->get('user'), 'phpbb_oauth_tokens', 'phpbb_oauth_accounts', $this->get('auth.provider.oauth.service_collection'), 'phpbb_users', './../', 'php');
    }
    ...
    {
        $this->services['auth.provider_collection'] = $instance = new \phpbb\di\service_collection($this);
    ...
    {
        $this->services['avatar.driver.upload'] = $instance = new \phpbb\avatar\driver\upload($this->get('config'), './../', 'php', $this->get('path_helper'), $this->get('cache.driver'));
    ...
    /**
     * Gets the 'cache.driver.install' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return phpbb\cache\driver\file A phpbb\cache\driver\file instance.
     */
    protected function getCache_Driver_InstallService()
    {
        return $this->services['cache.driver.install'] = new \phpbb\cache\driver\file();
    }
    ...
    {
        return $this->services['console.command.config.delete'] = new \phpbb\console\command\config\delete($this->get('config'));
    }
    ...
    {
        return $this->services['console.command.config.get'] = new \phpbb\console\command\config\get($this->get('config'));
    }
    ...
    {
        return $this->services['console.command.config.increment'] = new \phpbb\console\command\config\increment($this->get('config'));
    }
    ...
    {
        return $this->services['console.command.config.set'] = new \phpbb\console\command\config\set($this->get('config'));
    }
    ...
    {
        return $this->services['console.command.config.set_atomic'] = new \phpbb\console\command\config\set_atomic($this->get('config'));
    }
    ...
    {
        return $this->services['console.command.db.migrate'] = new \phpbb\console\command\db\migrate($this->get('migrator'), $this->get('ext.manager'), $this->get('config'), $this->get('cache'), $this->get('log'), $this->get('user'));
    }
    ...
    {
        return $this->services['console.command.extension.disable'] = new \phpbb\console\command\extension\disable($this->get('ext.manager'));
    }
    ...
    {
        return $this->services['console.command.extension.enable'] = new \phpbb\console\command\extension\enable($this->get('ext.manager'));
    }
    ...
    {
        return $this->services['console.command.extension.purge'] = new \phpbb\console\command\extension\purge($this->get('ext.manager'));
    }
    ...
    {
        return $this->services['console.command.extension.show'] = new \phpbb\console\command\extension\show($this->get('ext.manager'));
    }
    ...
    {
        return $this->services['console.command.fixup.recalculate_email_hash'] = new \phpbb\console\command\fixup\recalculate_email_hash($this->get('dbal.conn'));
    }
    ...
    {
        return $this->services['content.visibility'] = new \phpbb\content_visibility($this->get('auth'), $this->get('dbal.conn'), $this->get('user'), './../', 'php', 'phpbb_forums', 'phpbb_posts', 'phpbb_topics', 'phpbb_users');
    }
    ...
    {
        return $this->services['controller.helper'] = new \phpbb\controller\helper($this->get('template'), $this->get('user'), $this->get('config'), $this->get('controller.provider'), './../', 'php');
    }
    ...
    {
        $this->services['controller.provider'] = $instance = new \phpbb\controller\provider($this->get('ext.finder'));
    ...
    {
        $this->services['cron.task.core.prune_shadow_topics'] = $instance = new \phpbb\cron\task\core\prune_shadow_topics('./../', 'php', $this->get('config'), $this->get('dbal.conn'), $this->get('log'));
    ...
    {
        $this->services['dbal.conn'] = $instance = new \phpbb\db\driver\mysqli();

        $instance->sql_connect('localhost', 'root', '', 'phpbb', '', false, false);
    ...
    /**
     * Gets the 'event.listener_collection' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return phpbb\di\service_collection A phpbb\di\service_collection instance.
     */
    protected function getEvent_ListenerCollectionService()
    {
        return $this->services['event.listener_collection'] = new \phpbb\di\service_collection($this);
    }

    /**
     * Gets the 'event.subscriber_loader' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return phpbb\event\extension_subscriber_loader A phpbb\event\extension_subscriber_loader instance.
     */
    protected function getEvent_SubscriberLoaderService()
    {
        $this->services['event.subscriber_loader'] = $instance = new \phpbb\event\extension_subscriber_loader($this->get('dispatcher'), $this->get('event.listener_collection'));
    ...
    /**
     * Gets the 'ext.finder' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return phpbb\extension\finder A phpbb\extension\finder instance.
     */
    protected function getExt_FinderService()
    {
        return $this->services['ext.finder'] = new \phpbb\extension\finder($this->get('ext.manager'), $this->get('filesystem'), './../', $this->get('cache.driver'), 'php', '_ext_finder');
    }
    ...
    {
        return $this->services['ext.manager'] = new \phpbb\extension\manager($this, $this->get('dbal.conn'), $this->get('config'), $this->get('filesystem'), 'phpbb_ext', './../', 'php', $this->get('cache.driver'));
    }
    ...
    {
        return $this->services['kernel_request_subscriber'] = new \phpbb\event\kernel_request_subscriber($this->get('ext.finder'), './../', 'php');
    }
    ...
    {
        return $this->services['pagination'] = new \phpbb\pagination($this->get('template'), $this->get('user'), $this->get('controller.helper'));
    }
    ...
    {
        return $this->services['path_helper'] = new \phpbb\path_helper($this->get('symfony_request'), $this->get('filesystem'), './../', 'php', 'adm/');
    }
    ...
    {
        return $this->services['request'] = new \phpbb\request\request();
    }
    ...
    {
        return $this->services['user'] = new \phpbb\user();
    }
    ...
    {
        return new \phpbb\version_helper($this->get('cache'), $this->get('config'), $this->get('user'));
    }
